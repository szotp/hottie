...
class TestResult {
  ...
  static TestResult decode(Object result) {
    ...
    return TestResult(
      ...
      errors: (result[1] as List<Object?>?)!.cast<TestResultError>(),
    );
  }
  ...
  bool operator ==(Object other) {
    if (other is! TestResult || other.runtimeType != runtimeType) {
      return false;
    }
...
class TestResultError {
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! TestResultError || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class TestGroupResults extends FromIsolate {
  ...
  static TestGroupResults decode(Object result) {
    ...
    return TestGroupResults(
      skipped: result[0]! as int,
      failed: (result[1] as List<Object?>?)!.cast<TestResult>(),
      passed: (result[2] as List<Object?>?)!.cast<TestResult>(),
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! TestGroupResults || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
